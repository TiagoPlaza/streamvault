...
export default function ContentListClient({ viewStats }: ContentListClientProps) {
  ...
  // O useEffect que buscava /api/stats/views foi removido.
  // Agora usamos viewStats recebido via props do Server Component.
